...
const OnboardingInvest1 = ({ navigation, route }) => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <SafeAreaView style={styles.container}>
        ...
        >
          <Feather name="trending-up" size={70} color={colors.green} />
        </View>
        <View style={styles.titleSection}>
          <Text style={{ ...defaultStyles.headerMedium, textAlign: 'center', paddingHorizontal: 30 }}>
...
export default OnboardingInvest1;
