...
const StoryBoxGridSmall = ({ navigation, story, showProfilePic = true, handleProjectSelect }) => {
  if (story.type === 'PROJECT') {
    ...
    return (
      <TouchableOpacity onPress={() => handleProjectSelect(story)} style={styles.storyBox} activeOpacity={0.8}>
...
export default StoryBoxGridSmall;
