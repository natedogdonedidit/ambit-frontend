...
const TopicFollowButtonFreelance = ({ topicID, showX }) => {
      ...
      if (isFollowing) {
        ...
        updateOneUser({
          variables: {
            ...
            data: {
              topicsFreelance: { connect: [{ id: topicID }] },
            },
          },
        });
      } else {
        ...
        updateOneUser({
          variables: {
            where: { id: currentUserId }, // userLoggedIn
            data: {
              topicsFreelance: { disconnect: [{ id: topicID }] },
            },
          },
        });
      }
...
export default TopicFollowButtonFreelance;
